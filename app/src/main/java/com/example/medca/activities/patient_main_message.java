...
import com.example.medca.databinding.ActivityPatientMainMessageBinding;
...
public class patient_main_message extends AppCompatActivity implements ConversionListener {

    private PreferenceManager preferenceManager;
    private ActivityPatientMainMessageBinding binding;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_patient_main_message);

        binding = ActivityPatientMainMessageBinding.inflate(getLayoutInflater());
        ...
        binding.imageBackPatientMessage.setOnClickListener(new View.OnClickListener() {
            @Override
 ...
 /**           Bundle bundle = getIntent().getExtras();
    ...
    private void updateToken(String token){
        ...
        documentReference.update(Constants.KEY_FCM_TOKEN, token)
                //   .addOnSuccessListener(unused -> Toast.makeText(this, "Token is updated successfully", Toast.LENGTH_SHORT).show())
