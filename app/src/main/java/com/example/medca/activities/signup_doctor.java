        ...
        cont.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if(TextUtils.isEmpty(user)){
                    Toast.makeText(signup_doctor.this, "Please enter your email", Toast.LENGTH_SHORT).show();
                    username.setError("Email is required");
                    username.requestFocus();
                }else if(TextUtils.isEmpty(pass)){
                    Toast.makeText(signup_doctor.this, "Please enter your password", Toast.LENGTH_SHORT).show();
                    password.setError("Password is required");
                    password.requestFocus();
                }else if(pass.length() < 6){
                    Toast.makeText(signup_doctor.this, "Password should be 6 characters or longer", Toast.LENGTH_SHORT).show();
                    password.setError("Password too weak");
                    password.requestFocus();
                }else if(!pass.equals(repass)){
                    Toast.makeText(signup_doctor.this, "Password should be identical", Toast.LENGTH_SHORT).show();
                    ...
                    Intent intent = new Intent(signup_doctor.this, signup_doctor_2.class);
