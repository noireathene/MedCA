...
public class FCMAppointmentStatusNotification {
    String token;
    String title;
    String body;
    Context mContext;
    ...
    public FCMAppointmentStatusNotification(String token, String title, String body, Context mContext, Activity mActivity) {
        this.token = token;
        this.title = title;
        this.body = body;
    ...
    public void sendNotification(){
        ...
        try{
            ...
            dataObj.put("dataFrom", "FcmAppointmentStatusNotification");
