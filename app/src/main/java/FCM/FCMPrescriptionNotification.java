...
public class FCMPrescriptionNotification {
    String token;
    String title;
    String body;
    Context mContext;
    ...
    public FCMPrescriptionNotification(String token, String title, String body, Context mContext, Activity mActivity) {
        this.token = token;
        this.title = title;
        this.body = body;
    ...
    public void sendNotification(){
        ...
        try{
            ...
            dataObj.put("dataFrom", "FcmPrescriptionNotification");
